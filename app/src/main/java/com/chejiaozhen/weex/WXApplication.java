...
import com.chejiaozhen.weex.module.PayMoudle;
import com.chejiaozhen.weex.module.PictureMoudle;
...
//    initDebugEnvironment(true, false, "DEBUG_SERVER_HOST");
    ...
    try {
      ...
      //注册支付模块
      WXSDKEngine.registerModule("pay", PayMoudle.class);
      //注册相机模块
      WXSDKEngine.registerModule("camera", PictureMoudle.class);
      //注册通知
//      WXSDKEngine.registerModule("utils", GlobalEventMoudle.class);
    } catch (WXException e) {
      e.printStackTrace();
    }
